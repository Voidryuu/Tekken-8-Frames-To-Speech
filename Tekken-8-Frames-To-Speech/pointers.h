...
#define TEKKEN_VERSION "3.01.01"

#define P1_RECOVERY_FRAMES_STATIC_POINTER 0x9B87FD0
#define P1_RECOVERY_FRAMES_POINTER_OFFSETS {0x38, 0xFF0}

#define P1_STATE_STATIC_POINTER 0x9B87FD0
#define P1_STATE_POINTER_OFFSETS {0x30, 0x550}

#define P2_STATE_STATIC_POINTER 0x9B87FD0
